...
#                 st.code(f"Accuracy for Voting Classifier: {round(accuracy, 2)}", language='python')
#                 st.code(f"R2 Score for Voting Classifier: {round(r2, 2)}", language='python')

#         st.pyplot(fig)  # Show the ensemble boundaries
